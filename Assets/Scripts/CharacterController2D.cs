...
namespace Prime31
{
    ...
    public class CharacterController2D : MonoBehaviour
    {
        ...
        [HideInInspector] public CharacterCollisionState2D collisionState = new CharacterCollisionState2D();
        [HideInInspector] public Vector3 velocity;
        public bool isGrounded { get { return collisionState.below; } }
        public const float kSkinWidthFloatFudgeFactor = 0.001f;
        #endregion
        /// <summary>
        ...
        private void HandleVerticalSlope(ref Vector3 deltaMovement)
        {
            ...
            var slopeCheckRayDistance = _slopeLimitTangent * (raycastOrigins.bottomRight.x - centerOfCollider);
